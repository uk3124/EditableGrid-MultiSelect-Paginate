...
!function (t) {
    ...
    t.fn.Tabledit = function (e) {
        ...
        var i = this, a = {
          ...
          //  dangerClass: "danger", //Commented by Umar
            ...
            view: function (e) {
                ...
                c.reset(e);
                var n = t(e).parent("tr");
                n.find(".chosen-container").css('display','inline-block'); //Added by umar
            ...
            reset: function (e) {
                ...
                i !== !1 && (t(e).each(function () {
                    ...
                    //Custom code End - Umar

                    t(this).find(".tabledit-span").text(e.is("select") ? array : e.val()), u.view(this)
                }), s = t(e).parent("tr"))
            }
        }, c = {
            reset: function (t) {
